...
public class CustomCellActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ds.setName("Array");
        ds.setDescription("데이터를 순차적으로 연속해서 저장하는 자료 구조");
        list.add(ds);

        ds = new DataStructure();
        ds.setIcon(R.mipmap.ic_launcher);
        ds.setName("LinkedList");
        ds.setDescription("다음 데이터의 주소를 젖아해서 연속적으로 저장한 것처럼 보이도록 한 자료구조");
        list.add(ds);
        ...
        //위치 이동 애니메이션 생성
        Animation rtl = new TranslateAnimation(Animation.RELATIVE_TO_SELF, 1.0f, Animation.RELATIVE_TO_SELF, 0.0f, 
