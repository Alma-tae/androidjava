...
//        //EditText나 TextView의 입력된 문자열의 자료형은 Editable이나 CharSequence라서 String에 바로 대입이 안 됨
//        //반대로 설정할 때는 String이 Editable이나 CharSequence를 implements 했기 때문에 대입이 가능.
