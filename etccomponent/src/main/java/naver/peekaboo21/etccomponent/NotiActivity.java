package naver.peekaboo21.etccomponent;
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                    ...
                    String channelName = "One love Channel";
                    String channelDescription = "Sing together One love";
                ...
                PendingIntent receiverIntent = PendingIntent.getBroadcast(NotiActivity.this, 20,
                        new Intent(NotiActivity.this, NotiReceiver.class), PendingIntent.FLAG_UPDATE_CURRENT);
