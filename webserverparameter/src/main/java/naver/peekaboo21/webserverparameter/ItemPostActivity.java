    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnInsert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //입력한 데이터가 있는지 확인해서 입력한 데이터가 없다면 더 이상 작업 진행 안 함
                if(itemname.trim().isEmpty()){
                    msg.what = 0;
                    msg.obj = "아이템 이름은 필수입니다.";
                ...
                if(description.trim().isEmpty()){
                    msg.what = 0;
                    msg.obj = "아이템 설명은 필수입니다.";
                    handler.sendMessage(msg);
                    return;
                }

                //현재 시간은 yyyy-MM-dd hh:mm:ss 형식의 문자열로 만들기
                Date date = new Date();
                ...
                new Thread(){
                    ...
                    public void run(){
                        try {
                            ...
                            //서버에서 이 이름에 구별할 수 있는 코드를 추가해서 이름은 새로 만든다
                            String fileName = "avocado.png";
                            ...
                            //파라미터 전송
                            //POST 방식인 경우, 문자열을 전송하지 않고 바이트 배열을 전송한다.
                            ...
                            if(fileName != null){
                                ...
                                InputStream fres = getResources().openRawResource(R.raw.avocado);
                            ...
                            Log.e("업로드 예외 발생", e.getLocalizedMessage());
                ...
                new Thread(){
                    public void run(){
                        try{
                            ...
                            //itemid이고 정수입니다.
                            String data = URLEncoder.encode("itemid", "UTF-8")+"="+URLEncoder.encode("12", "UTF-8");
                            //파라미터 전송
                            ...
                            Log.e("삭제 예외 발생", e.getLocalizedMessage());
                        }
                    }
                }.start();
            }
