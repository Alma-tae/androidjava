            ...
            public void onClick(View v) {
                ...
                new Thread(){
                    ...
                    public void run(){
                        try {
                            //URL 작성
                            //파라미터 인코딩하기(Kakao는 지원을 해주지만, 다른 곳은 한글 변환 작업이 필요)
                            String query = URLEncoder.encode("자바", "utf-8");
                            URL url = new URL("https://dapi.kakao.com/v3/search/book?size=20&query=해리포터"+query);
                            ...
                            //헤더 설정
                            con.setRequestProperty("Authorization", "KakaoAK 2e6a16bc0c23489c201ead053137e62b");
                            ...
                            if(json != null){
                                ...
                                for(int i=0; i<documents.length(); i++){
                                    ...
                                    result = result + "제목:" + title + "내용:" + contents + "썸네일:"+ thumbnail+ "\n";
                                }
